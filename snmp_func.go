...
var CUPS_OID = []string{
	...
	"1.3.6.1.2.1.43.11.1.1.6.1", // CUPS_OID_prtMarkerSuppliesDescription
	"1.3.6.1.2.1.43.11.1.1.8.1", // CUPS_OID_prtMarkerSuppliesMaxCapacity
	"1.3.6.1.2.1.43.11.1.1.9.1", // CUPS_OID_prtMarkerSuppliesLevel
}
